...
def myCommand():
    ...
    try:
        command = r.recognize(audio).lower()
...
def assistant(command):
        if 'open reddit' in command:
            ...
            if reg_ex:
                ...
                sofiaResponse('I have launched the desired application')#play youtube song
    
        elif 'change wallpaper' in command:
            folder = 'E:\50 Most Amazing Collection of Computer Desktop Wallpapers - 4915 [ECLiPSE]'
            ...
            urllib.urlretrieve(photo, "E:\50 Most Amazing Collection of Computer Desktop Wallpapers - 4915 [ECLiPSE]") # Location where we download the image to.
